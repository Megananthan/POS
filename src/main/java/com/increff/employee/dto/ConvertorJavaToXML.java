...
//            ByteArrayOutputStream out = new ByteArrayOutputStream();
            ...
            Transformer transformer = factory.newTransformer(new StreamSource("src\\main\\resources\\com\\increff\\employee\\orderitem.xsl"));
            //Make sure the XSL transformation's result is piped through to FOP
            Result res = new SAXResult(fop.getDefaultHandler());

            //Setup input
            Source src = new StreamSource(new File("src\\main\\resources\\com\\increff\\employee\\orderitem.xml"));
...
//            response.getOutputStream().flush();
    ...
    public static void jaxbObjectToXML(OrderDetail d) 
    {
        try
        {
           ...
           //Store XML to File
            File file = new File("src\\main\\resources\\com\\increff\\employee\\orderitem.xml");
